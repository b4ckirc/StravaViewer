...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "dl_oauth_html_body":    {"it": "Puoi chiudere questa finestra e tornare all'applicazione.", "en": "You can close this window and return to the application.", "de": "Du kannst dieses Fenster schließen und zur Anwendung zurückkehren.", "fr": "Vous pouvez fermer cette fenêtre et retourner à l'application.", "es": "Puedes cerrar esta ventana y volver a la aplicación."},
    "dl_oauth_open_browser": {"it": "🌐 Apertura browser per autenticazione Strava…",  "en": "🌐 Opening browser for Strava authentication…",  "de": "🌐 Browser für Strava-Authentifizierung wird geöffnet…", "fr": "🌐 Ouverture du navigateur pour l'authentification Strava…", "es": "🌐 Abriendo el navegador para autenticación en Strava…"},
    "dl_oauth_authorize":    {"it": "   Accedi e autorizza l'app, poi torna qui.",      "en": "   Log in and authorize the app, then return here.", "de": "   Anmelden und App autorisieren, dann hierher zurückkehren.", "fr": "   Connectez-vous et autorisez l'app, puis revenez ici.", "es": "   Inicia sesión y autoriza la app, luego vuelve aquí."},
    "dl_oauth_timeout":      {"it": "Timeout autenticazione OAuth (3 minuti). Riprova.", "en": "OAuth authentication timeout (3 minutes). Please try again.", "de": "OAuth-Authentifizierung abgelaufen (3 Minuten). Erneut versuchen.", "fr": "Délai d'authentification OAuth expiré (3 minutes). Réessayez.", "es": "Tiempo de espera de OAuth (3 minutos). Inténtalo de nuevo."},
    "dl_requests_missing":   {"it": "Installa requests: pip install requests",          "en": "Install requests: pip install requests",          "de": "requests installieren: pip install requests",     "fr": "Installer requests : pip install requests",           "es": "Instala requests: pip install requests"},
    "dl_token_valid":        {"it": "✅ Token esistente ancora valido, nessun login necessario.", "en": "✅ Existing token still valid, no login required.", "de": "✅ Vorhandenes Token noch gültig, kein Login nötig.", "fr": "✅ Token existant encore valide, aucune connexion requise.", "es": "✅ Token existente aún válido, no es necesario iniciar sesión."},
    "dl_token_refreshing":   {"it": "🔄 Rinnovo token di accesso…",                    "en": "🔄 Refreshing access token…",                    "de": "🔄 Zugriffstoken wird erneuert…",                  "fr": "🔄 Renouvellement du token d'accès…",                  "es": "🔄 Renovando token de acceso…"},
    "dl_token_refreshed":    {"it": "✅ Token rinnovato.",                              "en": "✅ Token refreshed.",                             "de": "✅ Token erneuert.",                               "fr": "✅ Token renouvelé.",                                  "es": "✅ Token renovado."},
    "dl_oauth_exchanging":   {"it": "🔑 Scambio codice OAuth con token di accesso…",   "en": "🔑 Exchanging OAuth code for access token…",     "de": "🔑 OAuth-Code wird gegen Zugriffstoken eingetauscht…", "fr": "🔑 Échange du code OAuth contre un token d'accès…", "es": "🔑 Intercambiando código OAuth por token de acceso…"},
    "dl_authenticated_as":   {"it": "✅ Autenticato come: {name}",                     "en": "✅ Authenticated as: {name}",                     "de": "✅ Angemeldet als: {name}",                         "fr": "✅ Authentifié en tant que : {name}",                  "es": "✅ Autenticado como: {name}"},
    "dl_rate_limit":         {"it": "⏳ Rate limit Strava, attendo {wait}s…",           "en": "⏳ Strava rate limit hit, waiting {wait}s…",      "de": "⏳ Strava-Rate-Limit erreicht, warte {wait}s…",     "fr": "⏳ Limite de débit Strava atteinte, attente de {wait}s…", "es": "⏳ Límite de Strava alcanzado, esperando {wait}s…"},
    "dl_page_progress":      {"it": "📄 Pagina {page}: {count} corse (tot. {total})",  "en": "📄 Page {page}: {count} runs (total: {total})",  "de": "📄 Seite {page}: {count} Läufe (gesamt: {total})", "fr": "📄 Page {page} : {count} sorties (total : {total})", "es": "📄 Página {page}: {count} carreras (total: {total})"},
    "dl_log_start":          {"it": "🟠 Avvio richiesta…",                             "en": "🟠 Starting request…",                            "de": "🟠 Anfrage wird gestartet…",                        "fr": "🟠 Démarrage de la requête…",                          "es": "🟠 Iniciando solicitud…"},
    "dl_log_worker_started": {"it": "🔵 Thread worker avviato.",                       "en": "🔵 Worker thread started.",                       "de": "🔵 Worker-Thread gestartet.",                       "fr": "🔵 Thread de travail démarré.",                        "es": "🔵 Hilo de trabajo iniciado."},
    "dl_log_oauth_start":    {"it": "🔑 Avvio autenticazione OAuth…",                  "en": "🔑 Starting OAuth authentication…",               "de": "🔑 OAuth-Authentifizierung wird gestartet…",        "fr": "🔑 Démarrage de l'authentification OAuth…",            "es": "🔑 Iniciando autenticación OAuth…"},
    "dl_log_browser_soon":   {"it": "   Il browser si aprirà a breve.",                "en": "   Your browser will open shortly.",               "de": "   Der Browser wird gleich geöffnet.",              "fr": "   Votre navigateur va s'ouvrir sous peu.",            "es": "   El navegador se abrirá en breve."},
    "dl_log_fetching":       {"it": "📋 Recupero lista corse da Strava…",              "en": "📋 Fetching run list from Strava…",                "de": "📋 Laufliste von Strava wird abgerufen…",           "fr": "📋 Récupération de la liste des sorties depuis Strava…", "es": "📋 Obteniendo lista de carreras de Strava…"},
    "dl_log_runs_found":     {"it": "✅ {n} corse trovate su Strava.",                 "en": "✅ {n} runs found on Strava.",                     "de": "✅ {n} Läufe auf Strava gefunden.",                  "fr": "✅ {n} sorties trouvées sur Strava.",                   "es": "✅ {n} carreras encontradas en Strava."},
    "dl_log_downloading":    {"it": "⬇  [{i}/{total}] {name}",                        "en": "⬇  [{i}/{total}] {name}",                         "de": "⬇  [{i}/{total}] {name}",                          "fr": "⬇  [{i}/{total}] {name}",                             "es": "⬇  [{i}/{total}] {name}"},
    "dl_log_error_item":     {"it": "   ⚠ Errore: {err}",                             "en": "   ⚠ Error: {err}",                               "de": "   ⚠ Fehler: {err}",                               "fr": "   ⚠ Erreur : {err}",                                 "es": "   ⚠ Error: {err}"},
    "dl_log_completed":      {"it": "\n🏁 Completato: {new} nuove, {skip} già presenti, {err} errori.", "en": "\n🏁 Completed: {new} new, {skip} already present, {err} errors.", "de": "\n🏁 Abgeschlossen: {new} neu, {skip} bereits vorhanden, {err} Fehler.", "fr": "\n🏁 Terminé : {new} nouvelles, {skip} déjà présentes, {err} erreurs.", "es": "\n🏁 Completado: {new} nuevas, {skip} ya presentes, {err} errores."},
    "dl_log_critical":       {"it": "❌ Errore critico: {err}",                        "en": "❌ Critical error: {err}",                         "de": "❌ Kritischer Fehler: {err}",                       "fr": "❌ Erreur critique : {err}",                           "es": "❌ Error crítico: {err}"},
...
NOTA DEL ENTRENADOR: este modelo no conoce tu estado de forma actual. Consulta el gráfico CTL/TSB: si el TSB es positivo (+5 a +15) y el CTL está cerca del máximo histórico, apunta al P75. Si vienes de un bloque intenso o descanso, apunta al P25–P50.""",
    ...
    # ── Gear tab ──────────────────────────────────────────────────────────────
    "tab_gear":               {"it": "Gear",                  "en": "Gear",                  "de": "Ausrüstung",             "fr": "Équipement",             "es": "Equipamiento"},
    "gear_title":             {"it": "GEAR / SCARPE",         "en": "GEAR / SHOES",          "de": "AUSRÜSTUNG / SCHUHE",    "fr": "ÉQUIPEMENT / CHAUSSURES","es": "EQUIPAMIENTO / ZAPATILLAS"},
    "gear_no_data":           {"it": "Nessun dato gear trovato.\n\nAssicurati di aver impostato l'attrezzatura su Strava per le tue attività.", "en": "No gear data found.\n\nMake sure you have set gear on your Strava activities.", "de": "Keine Ausrüstungsdaten gefunden.\n\nStelle sicher, dass du Ausrüstung in Strava eingestellt hast.", "fr": "Aucune donnée d'équipement trouvée.\n\nAssurez-vous d'avoir défini l'équipement sur vos activités Strava.", "es": "No se encontraron datos de equipamiento.\n\nAsegúrate de haber configurado el equipamiento en tus actividades de Strava."},
    "gear_badge_items":       {"it": "elementi",              "en": "items",                 "de": "Artikel",                "fr": "éléments",               "es": "elementos"},
    "gear_badge_tracked":     {"it": "km monitorati",         "en": "km tracked",            "de": "km verfolgt",            "fr": "km suivis",              "es": "km rastreados"},
    "gear_section_gear":      {"it": "ATTREZZATURA",          "en": "GEAR",                  "de": "AUSRÜSTUNG",             "fr": "ÉQUIPEMENT",             "es": "EQUIPAMIENTO"},
    "gear_section_monthly":   {"it": "KM MENSILI PER GEAR",   "en": "MONTHLY KM PER GEAR",   "de": "MONATLICHE KM PRO GEAR", "fr": "KM MENSUELS PAR GEAR",   "es": "KM MENSUALES POR GEAR"},
    "gear_status_ok":         {"it": "OK",                    "en": "OK",                    "de": "OK",                     "fr": "OK",                     "es": "OK"},
    "gear_status_warn":       {"it": "Vicino al limite",      "en": "Near limit",            "de": "Fast am Limit",          "fr": "Près de la limite",      "es": "Cerca del límite"},
    "gear_status_replace":    {"it": "Sostituire presto",     "en": "Replace soon",          "de": "Bald ersetzen",          "fr": "À remplacer bientôt",    "es": "Reemplazar pronto"},
    "gear_stat_runs":         {"it": "corse",                 "en": "runs",                  "de": "Läufe",                  "fr": "sorties",                "es": "carreras"},
    "gear_stat_avg_pace":     {"it": "Passo medio",           "en": "Avg pace",              "de": "Ø Tempo",                "fr": "Allure moy.",            "es": "Ritmo medio"},
    "gear_threshold_label":   {"it": "Soglia sostituzione:",  "en": "Replacement threshold:","de": "Austauschschwelle:",      "fr": "Seuil de remplacement :", "es": "Umbral de reemplazo:"},
    "gear_btn_save":          {"it": "Salva",                 "en": "Save",                  "de": "Speichern",              "fr": "Enregistrer",            "es": "Guardar"},
    "gear_btn_dismiss":       {"it": "✕ Dismetti",            "en": "✕ Dismiss",             "de": "✕ Ablegen",              "fr": "✕ Archiver",             "es": "✕ Archivar"},
    "gear_btn_restore":       {"it": "↩ Ripristina",          "en": "↩ Restore",             "de": "↩ Wiederherstellen",     "fr": "↩ Restaurer",            "es": "↩ Restaurar"},
    "gear_section_dismissed": {"it": "GEAR DISMESSO",         "en": "DISMISSED GEAR",        "de": "ABGELEGTE AUSRÜSTUNG",   "fr": "ÉQUIPEMENT ARCHIVÉ",     "es": "EQUIPAMIENTO ARCHIVADO"},
    "gear_no_active":         {"it": "Nessun gear attivo.",   "en": "No active gear.",       "de": "Keine aktive Ausrüstung.","fr": "Aucun équipement actif.", "es": "Sin equipamiento activo."},
    "gear_chart_toggle_label":{"it": "Mostra:",               "en": "Show:",                 "de": "Anzeigen:",              "fr": "Afficher :",             "es": "Mostrar:"},
    "gear_chart_none_selected":{"it": "Nessun gear selezionato.", "en": "No gear selected.", "de": "Keine Ausrüstung ausgewählt.", "fr": "Aucun équipement sélectionné.", "es": "Ningún equipamiento seleccionado."},
    "gear_chart_title":       {"it": "Km mensili per gear (ultimi 12 mesi)", "en": "Monthly km per gear (last 12 months)", "de": "Monatliche km pro Gear (letzte 12 Monate)", "fr": "Km mensuels par gear (12 derniers mois)", "es": "Km mensuales por gear (últimos 12 meses)"},
    "gear_info_title":        {"it": "Come funziona il tracker gear", "en": "How the gear tracker works", "de": "Wie der Gear-Tracker funktioniert", "fr": "Comment fonctionne le suivi d'équipement", "es": "Cómo funciona el rastreador de equipamiento"},
    "gear_info_body": {
        "it": "## Tracker Gear / Scarpe\n\nQuesta sezione aggrega automaticamente i km percorsi per ogni elemento di attrezzatura impostato su Strava.\n\n# Come funziona\n\n• I dati di attrezzatura provengono direttamente dalle attività Strava scaricate nel database.\n• Per ogni gear viene calcolato: km totali, numero di corse, passo medio, data prima/ultima uscita.\n• La barra di avanzamento mostra quanto sei vicino alla soglia di sostituzione configurabile.\n\n# Soglia di sostituzione\n\n• Il valore predefinito è 700 km, ideale per la maggior parte delle scarpe da running.\n• Puoi personalizzare la soglia per ogni scarpa con il campo di testo e il pulsante Salva.\n• Le soglie vengono salvate in MongoDB e ricordate tra le sessioni.\n\n# Indicatori di stato\n\n• ✓ OK — meno dell'80% della soglia raggiunta.\n• → Vicino al limite — tra l'80% e il 100%.\n• ⚠ Sostituire presto — soglia superata.\n\n# Come aggiungere gear a Strava\n\n• Vai su Strava → Impostazioni → Il mio equipaggiamento → Aggiungi scarpe.\n• Associa le scarpe a ogni attività durante il salvataggio o in modifica.\n\nNOTE: Il gear non appare qui se non è stato impostato su Strava. Riscaricare le attività dopo aver aggiunto l'attrezzatura.",
        "en": "## Gear / Shoe Tracker\n\nThis section automatically aggregates km run per gear item set on Strava.\n\n# How it works\n\n• Gear data comes directly from Strava activities downloaded to the database.\n• For each gear: total km, run count, average pace, first/last use date.\n• The progress bar shows how close you are to the configurable replacement threshold.\n\n# Replacement threshold\n\n• Default is 700 km, suitable for most running shoes.\n• You can customise the threshold per shoe using the text field and Save button.\n• Thresholds are saved in MongoDB and remembered between sessions.\n\n# Status indicators\n\n• ✓ OK — less than 80% of threshold reached.\n• → Near limit — between 80% and 100%.\n• ⚠ Replace soon — threshold exceeded.\n\n# How to add gear on Strava\n\n• Go to Strava → Settings → My Gear → Add shoes.\n• Assign shoes to each activity when saving or by editing.\n\nNOTE: Gear won't appear here if it hasn't been set on Strava. Re-download activities after adding gear.",
        "de": "## Ausrüstungs-/Schuh-Tracker\n\nDieser Bereich aggregiert automatisch die km pro Ausrüstungsartikel, der auf Strava eingestellt wurde.\n\n# Funktionsweise\n\n• Ausrüstungsdaten stammen direkt aus den in die Datenbank heruntergeladenen Strava-Aktivitäten.\n• Pro Ausrüstung: Gesamt-km, Laufanzahl, Durchschnittstempo, Erst-/Letztnutzungsdatum.\n• Der Fortschrittsbalken zeigt, wie nah du der konfigurierbaren Austauschhchwelle bist.\n\n# Austauschschwelle\n\n• Standard ist 700 km, geeignet für die meisten Laufschuhe.\n• Du kannst die Schwelle pro Schuh mit dem Textfeld und dem Speichern-Button anpassen.\n• Schwellen werden in MongoDB gespeichert.\n\n# Statusindikatoren\n\n• ✓ OK — weniger als 80% der Schwelle erreicht.\n• → Fast am Limit — zwischen 80% und 100%.\n• ⚠ Bald ersetzen — Schwelle überschritten.\n\nHINWEIS: Gear erscheint hier nicht, wenn es nicht auf Strava eingestellt wurde.",
        "fr": "## Suivi d'équipement / chaussures\n\nCette section agrège automatiquement les km parcourus par équipement configuré sur Strava.\n\n# Fonctionnement\n\n• Les données d'équipement proviennent directement des activités Strava téléchargées.\n• Par équipement : km totaux, nombre de sorties, allure moyenne, dates de première/dernière utilisation.\n• La barre de progression montre votre proximité avec le seuil de remplacement.\n\n# Seuil de remplacement\n\n• Valeur par défaut : 700 km, adaptée à la plupart des chaussures de running.\n• Personnalisable par chaussure via le champ texte et le bouton Enregistrer.\n• Les seuils sont sauvegardés dans MongoDB.\n\n# Indicateurs de statut\n\n• ✓ OK — moins de 80% du seuil atteint.\n• → Près de la limite — entre 80% et 100%.\n• ⚠ À remplacer bientôt — seuil dépassé.\n\nNOTE : L'équipement n'apparaît pas ici s'il n'a pas été configuré sur Strava.",
    ...
    "intervals_not_detected":     {"it": "✗  Non è un allenamento a intervalli", "en": "✗  Not an interval session", "de": "✗  Kein Intervalltraining", "fr": "✗  Pas une séance d'intervalles", "es": "✗  No es una sesión de intervalos"},
    "intervals_no_splits":        {"it": "Dati splits insufficienti (min. 4 km).", "en": "Insufficient splits data (min. 4 km).", "de": "Zu wenige Splits (min. 4 km).", "fr": "Données de splits insuffisantes (min. 4 km).", "es": "Datos de parciales insuficientes (mín. 4 km)."},
    "intervals_reason_too_few_splits":   {"it": "Troppi pochi km per analizzare la struttura.", "en": "Too few km to analyse workout structure.", "de": "Zu wenige km zur Strukturanalyse.", "fr": "Trop peu de km pour analyser la structure.", "es": "Muy pocos km para analizar la estructura."},
    "intervals_reason_no_valid_paces":   {"it": "Nessun dato di passo valido.", "en": "No valid pace data found.", "de": "Keine gültigen Tempodaten.", "fr": "Aucune donnée d'allure valide.", "es": "No se encontraron datos de ritmo válidos."},
    "intervals_reason_no_pattern":       {"it": "Il profilo di passo è troppo uniforme per essere un allenamento strutturato.", "en": "Pace profile is too uniform to be a structured workout.", "de": "Das Tempoprofil ist zu gleichmäßig für ein strukturiertes Training.", "fr": "Le profil d'allure est trop uniforme pour une séance structurée.", "es": "El perfil de ritmo es demasiado uniforme para ser un entrenamiento estructurado."},
    "intervals_reason_no_alternation":   {"it": "Nessuna alternanza rilevata tra tratti veloci e lenti.", "en": "No alternation detected between fast and slow segments.", "de": "Keine Abwechslung zwischen schnellen und langsamen Abschnitten.", "fr": "Aucune alternance détectée entre segments rapides et lents.", "es": "No se detectó alternancia entre segmentos rápidos y lentos."},
    "intervals_badge_reps":       {"it": "{n} ripetizioni",       "en": "{n} repetitions",       "de": "{n} Wiederholungen",      "fr": "{n} répétitions",         "es": "{n} repeticiones"},
    "intervals_stat_work_pace":   {"it": "Passo lavoro",          "en": "Work pace",             "de": "Arbeitstempo",            "fr": "Allure travail",          "es": "Ritmo trabajo"},
    "intervals_stat_recovery_pace":{"it": "Passo recupero",       "en": "Recovery pace",         "de": "Erholungstempo",          "fr": "Allure récupération",     "es": "Ritmo recuperación"},
    "intervals_stat_fade_rate":   {"it": "Fade rate",             "en": "Fade rate",             "de": "Ermüdungsrate",           "fr": "Taux de déclin",          "es": "Tasa de fatiga"},
    "intervals_stat_consistency": {"it": "Consistenza",           "en": "Consistency",           "de": "Konsistenz",              "fr": "Régularité",              "es": "Consistencia"},
    "intervals_std_label":        {"it": "Dev. std. passo",       "en": "Pace std dev",          "de": "Tempo-Standardabw.",      "fr": "Écart-type allure",       "es": "Desv. estándar ritmo"},
    "intervals_cv_label":         {"it": "Coefficiente variaz.",  "en": "Variation coeff.",      "de": "Variationskoeff.",        "fr": "Coeff. de variation",     "es": "Coef. de variación"},
    "intervals_col_num":          {"it": "#",                     "en": "#",                     "de": "#",                      "fr": "#",                       "es": "#"},
    "intervals_col_type":         {"it": "TIPO",                  "en": "TYPE",                  "de": "TYP",                    "fr": "TYPE",                    "es": "TIPO"},
    "intervals_col_dist":         {"it": "DIST.",                 "en": "DIST.",                 "de": "DIST.",                  "fr": "DIST.",                   "es": "DIST."},
    "intervals_col_time":         {"it": "TEMPO",                 "en": "TIME",                  "de": "ZEIT",                   "fr": "TEMPS",                   "es": "TIEMPO"},
    "intervals_col_pace":         {"it": "PASSO",                 "en": "PACE",                  "de": "TEMPO",                  "fr": "ALLURE",                  "es": "RITMO"},
    "intervals_col_hr":           {"it": "HR",                    "en": "HR",                    "de": "HF",                     "fr": "FC",                      "es": "FC"},
    "intervals_col_vs_avg":       {"it": "vs Media",              "en": "vs Avg",                "de": "vs Ø",                   "fr": "vs Moy.",                 "es": "vs Med."},
    "intervals_type_work":        {"it": "Lavoro",                "en": "Work",                  "de": "Arbeit",                 "fr": "Travail",                 "es": "Trabajo"},
    "intervals_type_rest":        {"it": "Recupero",              "en": "Rest",                  "de": "Erholung",               "fr": "Récupération",            "es": "Recuperación"},
    "intervals_section_table":    {"it": "TABELLA SEGMENTI",      "en": "SEGMENT TABLE",         "de": "SEGMENTTABELLE",         "fr": "TABLEAU DES SEGMENTS",    "es": "TABLA DE SEGMENTOS"},
    "intervals_section_charts":   {"it": "GRAFICI",               "en": "CHARTS",                "de": "DIAGRAMME",              "fr": "GRAPHIQUES",              "es": "GRÁFICOS"},
    "intervals_chart_pace":       {"it": "Passo per segmento",    "en": "Pace per segment",      "de": "Tempo pro Segment",      "fr": "Allure par segment",      "es": "Ritmo por segmento"},
    "intervals_chart_hr":         {"it": "HR per segmento",       "en": "HR per segment",        "de": "HF pro Segment",         "fr": "FC par segment",          "es": "FC por segmento"},
    "intervals_wtype_vo2max":     {"it": "Intervalli VO₂max",     "en": "VO₂max Intervals",      "de": "VO₂max-Intervalle",       "fr": "Intervalles VO₂max",      "es": "Intervalos VO₂max"},
    "intervals_wtype_threshold":  {"it": "Intervalli a soglia",   "en": "Threshold Intervals",   "de": "Schwellen-Intervalle",   "fr": "Intervalles au seuil",    "es": "Intervalos de umbral"},
    "intervals_wtype_tempo":      {"it": "Tempo / Progressivo",   "en": "Tempo / Progressive",   "de": "Tempo / Progressiv",     "fr": "Tempo / Progressif",      "es": "Tempo / Progresivo"},
    "intervals_wtype_fartlek":    {"it": "Fartlek",               "en": "Fartlek",               "de": "Fartlek",                "fr": "Fartlek",                 "es": "Fartlek"},
    "intervals_wtype_easy_strides":{"it": "Allunghi su fondo lento","en": "Easy Strides",        "de": "Leichte Strides",        "fr": "Foulées légères",         "es": "Zancadas ligeras"},
    "intervals_info_title":       {"it": "Come funziona il rilevamento intervalli", "en": "How interval detection works", "de": "Wie die Intervallerkennung funktioniert", "fr": "Comment fonctionne la détection d'intervalles", "es": "Cómo funciona la detección de intervalos"},
    "intervals_info_body": {
        "it": "## Rilevamento automatico degli intervalli\n\nL'algoritmo analizza i dati di passo per km e identifica se l'allenamento presenta una struttura a intervalli.\n\n# Come funziona\n\n• Calcola il passo medio e la deviazione standard di tutti i km.\n• Classifica ogni km come VELOCE (< media − 0.5σ), LENTO (> media + 0.5σ) o NEUTRO.\n• Verifica che esista una vera alternanza tra segmenti veloci e lenti.\n• Richiede almeno 3 tratti veloci e un coefficiente di variazione ≥ 6%.\n\n# Tipi di allenamento\n\n• VO₂max — brevi ripetute (< 600 m), passo molto più veloce della media.\n• Soglia — ripetute medie/lunghe con passo chiaramente più veloce.\n• Tempo/Progressivo — variazione moderata con molti tratti veloci.\n• Fartlek — poche variazioni di ritmo non strutturate.\n• Allunghi — piccole accelerazioni su fondo lento.\n\n# Metriche chiave\n\n• Consistenza — quanto sono uniformi le ripetute veloci (100 = perfetto).\n• Fade rate — differenza tra il passo dell'ultima e della prima ripetuta. Positivo = affaticamento.\n\nNOTE: Il rilevamento si basa solo sui dati di passo per km. Sessioni su tapis roulant o con GPS impreciso potrebbero non essere rilevate correttamente.",
        "en": "## Automatic interval detection\n\nThe algorithm analyses per-km pace data to identify whether a workout has a structured interval pattern.\n\n# How it works\n\n• Computes average pace and standard deviation across all km splits.\n• Labels each km as FAST (< avg − 0.5σ), SLOW (> avg + 0.5σ) or NEUTRAL.\n• Verifies that a true alternation between fast and slow segments exists.\n• Requires at least 3 fast segments and a coefficient of variation ≥ 6%.\n\n# Workout types\n\n• VO₂max — short repeats (< 600 m), much faster than average.\n• Threshold — medium/long repeats clearly faster than average pace.\n• Tempo/Progressive — moderate variation with many fast segments.\n• Fartlek — few unstructured pace changes.\n• Easy Strides — small accelerations within an easy run.\n\n# Key metrics\n\n• Consistency — how uniform the fast repeats are (100 = perfect).\n• Fade rate — difference between last and first work interval pace. Positive = fatigue.\n\nNOTE: Detection is based on per-km splits only. Treadmill sessions or poor GPS accuracy may not be detected correctly.",
        "de": "## Automatische Intervallerkennung\n\nDer Algorithmus analysiert die Tempo-pro-km-Daten, um festzustellen, ob das Training eine strukturierte Intervallstruktur aufweist.\n\n# Funktionsweise\n\n• Berechnet Durchschnittstempo und Standardabweichung aller km-Splits.\n• Klassifiziert jeden km als SCHNELL (< Ø − 0,5σ), LANGSAM (> Ø + 0,5σ) oder NEUTRAL.\n• Prüft, ob eine echte Abwechslung zwischen schnellen und langsamen Segmenten besteht.\n• Erfordert mindestens 3 schnelle Abschnitte und einen Variationskoeffizient ≥ 6%.\n\n# Trainingstypen\n\n• VO₂max — kurze Wiederholungen (< 600 m), deutlich schneller als Durchschnitt.\n• Schwelle — mittlere/lange Wiederholungen klar schneller als Durchschnitt.\n• Tempo/Progressiv — moderate Variation mit vielen schnellen Abschnitten.\n• Fartlek — wenige unstrukturierte Tempowechsel.\n• Strides — kleine Beschleunigungen in einem lockeren Lauf.\n\n# Schlüsselmetriken\n\n• Konsistenz — Gleichmäßigkeit der schnellen Wiederholungen (100 = perfekt).\n• Ermüdungsrate — Differenz zwischen letztem und erstem Arbeitsintervall-Tempo.\n\nHINWEIS: Erkennung basiert nur auf km-Splits. Laufband-Sessions oder ungenaues GPS werden möglicherweise nicht korrekt erkannt.",
        "fr": "## Détection automatique des intervalles\n\nL'algorithme analyse les données d'allure par km pour identifier si la séance présente une structure d'intervalles.\n\n# Fonctionnement\n\n• Calcule l'allure moyenne et l'écart-type de tous les splits par km.\n• Classe chaque km comme RAPIDE (< moy. − 0,5σ), LENT (> moy. + 0,5σ) ou NEUTRE.\n• Vérifie qu'il existe une vraie alternance entre segments rapides et lents.\n• Nécessite au moins 3 segments rapides et un coefficient de variation ≥ 6%.\n\n# Types d'entraînement\n\n• VO₂max — courtes répétitions (< 600 m), bien plus rapides que la moyenne.\n• Seuil — répétitions moyennes/longues nettement plus rapides.\n• Tempo/Progressif — variation modérée avec de nombreux segments rapides.\n• Fartlek — peu de changements d'allure non structurés.\n• Foulées légères — petites accélérations dans une sortie facile.\n\n# Métriques clés\n\n• Régularité — uniformité des répétitions rapides (100 = parfait).\n• Taux de déclin — différence entre le dernier et le premier intervalle de travail.\n\nNOTE : La détection repose uniquement sur les splits par km. Les séances sur tapis ou avec GPS imprécis peuvent ne pas être détectées correctement.",
        "es": "## Detección automática de intervalos\n\nEl algoritmo analiza los datos de ritmo por km para identificar si el entrenamiento tiene una estructura de intervalos.\n\n# Cómo funciona\n\n• Calcula el ritmo medio y la desviación estándar de todos los parciales por km.\n• Clasifica cada km como RÁPIDO (< media − 0,5σ), LENTO (> media + 0,5σ) o NEUTRO.\n• Verifica que exista una verdadera alternancia entre segmentos rápidos y lentos.\n• Requiere al menos 3 segmentos rápidos y un coeficiente de variación ≥ 6%.\n\n# Tipos de entrenamiento\n\n• VO₂max — repeticiones cortas (< 600 m), mucho más rápidas que la media.\n• Umbral — repeticiones medias/largas claramente más rápidas.\n• Tempo/Progresivo — variación moderada con muchos segmentos rápidos.\n• Fartlek — pocos cambios de ritmo no estructurados.\n• Zancadas ligeras — pequeñas aceleraciones dentro de una carrera suave.\n\n# Métricas clave\n\n• Consistencia — uniformidad de las repeticiones rápidas (100 = perfecto).\n• Tasa de fatiga — diferencia entre el último y el primer intervalo de trabajo.\n\nNOTA: La detección se basa solo en parciales por km. Las sesiones en cinta o con GPS impreciso pueden no detectarse correctamente.",
    },
